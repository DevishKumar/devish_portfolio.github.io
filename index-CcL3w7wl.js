 ...
 */ (function (e) {
  ...
  function r(C) {
    ...
    if (z !== j) {
      C[0] = z;
      e: for (var Q = 0, X = C.length, tr = X >>> 1; Q < tr; ) {
        var yt = 2 * (Q + 1) - 1,
          kl = C[yt],
          gt = yt + 1,
          nr = C[gt];
        if (0 > l(kl, z))
          gt < X && 0 > l(nr, kl)
            ? ((C[Q] = nr), (C[gt] = z), (Q = gt))
            : ((C[Q] = kl), (C[yt] = z), (Q = yt));
        else if (gt < X && 0 > l(nr, z)) (C[Q] = nr), (C[gt] = z), (Q = gt);
        else break e;
      }
    }
    return j;
  ...
  function E(C, j) {
    ...
    try {
      ...
      if (m !== null) var tr = !0;
        ...
        var yt = n(c);
        yt !== null && wl(y, yt.startTime - j), (tr = !1);
      }
      return tr;
    } finally {
      (m = null), (p = z), (w = !1);
      ...
      return (
        ...
        z > Q
          ? ((C.sortIndex = z),
            ...
            n(s) === null &&
              C === n(c) &&
              (x ? (f(P), (P = -1)) : (x = !0), wl(y, z - Q)))
          : ((C.sortIndex = X), t(s, C), k || w || ((k = !0), gl(E))),
        C
      );
    }),
...
function gs() {
  if (Gt) {
    var e = Gt,
      t = Yt;
    if (((Yt = Gt = null), Wo(e), t)) for (e = 0; e < t.length; e++) Wo(t[e]);
  }
}
function ws(e, t) {
  return e(t);
...
function Ac(e, t, n, r, l, i, o, u, s) {
  (Nn = !1), (Rr = null), Fc.apply(Uc, arguments);
}
function $c(e, t, n, r, l, i, o, u, s) {
  if ((Ac.apply(this, arguments), Nn)) {
    if (Nn) {
      var c = Rr;
      (Nn = !1), (Rr = null);
...
var Ie = Math.clz32 ? Math.clz32 : Xc,
  Gc = Math.log,
  Yc = Math.LN2;
function Xc(e) {
...
function Sr(e) {
  ...
  for (var t = e.targetContainers; 0 < t.length; ) {
    ...
    } else return (t = bn(n)), t !== null && qi(t), (e.blockedOn = n), !1;
    t.shift();
  }
  return !0;
}
...
function Un(e) {
  ...
  for (; 0 < et.length && ((n = et[0]), n.blockedOn === null); )
    Ms(n), n.blockedOn === null && et.shift();
}
...
function bi(e, t, n, r) {
  if (Fr) {
    var l = fi(e, t, n, r);
    if (l === null) Ol(e, t, r, Ur, n), Yo(e, r);
  ...
  ll = V({}, qn, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== hn &&
            (hn && e.type === "mousemove"
              ? ((Pl = e.screenX - hn.screenX), (jl = e.screenY - hn.screenY))
              : (jl = Pl = 0),
            (hn = e)),
          Pl);
    },
...
var jf = We && "TextEvent" in window && !_n,
  Fs = We && (!ro || (_n && 8 < _n && 11 >= _n)),
  eu = " ",
  tu = !1;
function Us(e, t) {
  switch (e) {
...
function Bs(e) {
  if (e.propertyName === "value" && il(An)) {
    var t = [];
    $s(t, An, e, Xi(e)), xs(If, t);
  }
}
function Mf(e, t, n) {
  e === "focusin"
    ? (lu(), (Pn = t), (An = n), Pn.attachEvent("onpropertychange", Bs))
    : e === "focusout" && lu();
}
function Df(e) {
...
function ol(e) {
  ...
  var t = Ut[e],
    n;
  for (n in t) if (t.hasOwnProperty(n) && n in Ws) return (Il[e] = t[n]);
  return e;
}
...
var En =
  ...
  Hf = new Set("cancel close invalid load scroll toggle".split(" ").concat(En));
function au(e, t, n) {
  ...
  xs(function () {
    ...
    e: {
      ...
      if (p !== void 0) {
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              y !== null &&
              ((d = y),
              f !== null && ((y = Dn(a, f)), y != null && x.push(Bn(a, y, d)))),
            F)
          )
            break;
          a = a.return;
        ...
        0 < x.length &&
          ((p = new w(p, k, null, n, h)), m.push({ event: p, listeners: x }));
      }
    }
    if (!(t & 7)) {
      e: {
        ...
        if (
          ...
          if (
            ...
            (F = w == null ? p : At(w)),
            (d = k == null ? p : At(k)),
            (p = new x(y, a + "leave", w, n, h)),
            (p.target = F),
            (p.relatedTarget = d),
            (y = null),
            xt(h) === c &&
              ((x = new x(f, a + "enter", k, n, h)),
              (x.target = d),
              (x.relatedTarget = F),
              (y = x)),
            (F = y),
...
function vt() {
  if (!Ul && Ve !== null) {
    ...
    try {
      ...
      throw (Ve !== null && (Ve = Ve.slice(e + 1)), Ns(Zi, vt), l);
    } finally {
      (R = t), (Ul = !1);
    }
  }
...
function ta(e, t, n) {
  (xe[Se++] = Be), (xe[Se++] = He), (xe[Se++] = Pt), (Pt = e);
  var r = Be;
  e = He;
  var l = 32 - Ie(r) - 1;
  (r &= ~(1 << l)), (n += 1);
...
function mo(e, t) {
  switch ((M(Wn, t), M(Qn, e), M(Ae, er), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
function Ea(e, t, n) {
  return jt & 21
    ? (Me(n, t) || ((n = js()), ($.lanes |= n), (zt |= n), (e.baseState = !0)),
      t)
...
function nd(e, t, n) {
  ...
  if (Na(e)) _a(t, l);
    ...
    (n = oa(e, t, l, r)),
      n !== null && ((l = ue()), Re(n, e, r, l), Pa(n, t, r));
  }
}
function Na(e) {
  var t = e.alternate;
...
function Ci(e, t, n, r) {
  ...
  typeof i == "object" && i !== null
    ? (l.context = Ne(i))
    : ((i = pe(t) ? _t : le.current), (l.context = bt(e, i))),
...
function Lu(e, t, n, r, l) {
  ...
  if ((Zt(t, l), t.stateNode === null))
    jr(e, t), ja(t, n, r), Ci(t, n, r, l), (r = !0);
  else if (e === null) {
    var o = t.stateNode,
      u = t.memoizedProps;
    o.props = u;
...
function sd(e, t, n, r, l, i, o) {
  ...
  if (((u = (o & e.childLanes) !== 0), fe || u)) {
    ...
    return jo(), (r = Hl(Error(g(421)))), vr(e, t, o, r);
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || A.current & 1 ? Y === 0 && (Y = 3) : jo())),
          t.updateQueue !== null && (t.flags |= 4),
          ne(t),
          null);
    case 4:
      return (
        nn(), Li(e, t), e === null && Vn(t.stateNode.containerInfo), ne(t), null
      );
    case 10:
...
function pd(e, t) {
  ...
  for (hi = { focusedElem: e, selectionRange: n }, Fr = !1, S = t; S !== null; )
...
function $a(e) {
  ...
  t !== null && ((e.alternate = null), $a(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Fe], delete t[Hn], delete t[gi], delete t[Xf], delete t[Zf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Ha(e, t) {
  ...
  switch (e.tag) {
    ...
    case 3:
      if (
        (je(t, e), De(e), r & 4 && n !== null && n.memoizedState.isDehydrated)
      )
        try {
          Un(t.containerInfo);
        } catch (x) {
...
function Re(e, t, n, r) {
  if (50 < In) throw ((In = 0), (Oi = null), Error(g(185)));
  Jn(e, n, r),
    (!(I & 2) || e !== J) &&
      (e === J && (!(I & 2) && (dl |= n), Y === 4 && tt(e, b)),
      me(e, r),
      n === 1 && I === 0 && !(t.mode & 1) && ((ln = W() + 500), sl && vt()));
}
function me(e, t) {
...
function Wa(e, t) {
  if (((zr = -1), (Lr = 0), I & 6)) throw Error(g(327));
  var n = e.callbackNode;
  ...
  if (r & 30 || r & e.expiredLanes || t) t = el(e, r);
    ...
    I |= 2;
    var i = Ga();
    (J !== e || b !== t) && (($e = null), (ln = W() + 500), Ct(e, t));
    do
      try {
        gd();
        break;
  ...
  if (t !== 0) {
    if (
      ...
      throw ((n = Xn), Ct(e, 0), tt(e, r), me(e, W()), n);
    if (t === 6) tt(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = yi(kt.bind(null, e, ce, $e), t);
            break;
          }
          kt(e, ce, $e);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = yi(kt.bind(null, e, ce, $e), r);
            break;
          }
          kt(e, ce, $e);
          break;
  ...
  return me(e, W()), e.callbackNode === n ? Wa.bind(null, e) : null;
}
function Fi(e, t) {
  var n = Tn;
  return (
...
function Au(e) {
  ...
  if (n === 1) throw ((n = Xn), Ct(e, 0), tt(e, t), me(e, W()), n);
...
function _o(e, t) {
  ...
  try {
    ...
    (I = n), I === 0 && ((ln = W() + 500), sl && vt());
  }
}
function Lt(e) {
  rt !== null && rt.tag === 0 && !(I & 6) && Jt();
  var t = I;
  I |= 1;
  var n = Ce.transition,
    r = R;
  try {
    ...
    (R = r), (Ce.transition = n), (I = t), !(I & 6) && vt();
  }
}
function Po() {
  (he = Wt.current), O(Wt);
...
function jo() {
  (Y === 0 || Y === 3 || Y === 2) && (Y = 4),
    J === null || (!(zt & 268435455) && !(dl & 268435455)) || tt(J, b);
}
function el(e, t) {
  var n = I;
  I |= 2;
  ...
  while (!0);
  if ((ao(), (I = n), (Jr.current = r), K !== null)) throw Error(g(261));
  return (J = null), (b = 0), Y;
}
function yd() {
  for (; K !== null; ) Ya(K);
  ...
  if (rt !== null) {
    ...
    try {
      if (((Ce.transition = null), (R = 16 > e ? 16 : e), rt === null))
        ...
        if (
          ((I = l), vt(), Ue && typeof Ue.onPostCommitFiberRoot == "function")
        )
          try {
...
Ja = function (e, t, n) {
  ...
  else (fe = !1), U && t.flags & 1048576 && ta(t, Qr, t.index);
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Ji(t, n | 1), me(t, W()), !(I & 6) && ((ln = W() + 500), vt()));
      }
      break;
    case 13:
      Lt(function () {
...
ws = _o;
ks = Lt;
var zd = { usingClientEntryPoint: !1, Events: [bn, At, ul, ys, gs, _o] },
  gn = {
...
var Td = ns.exports,
  rc,
  Hu = Td;
(rc = Hu.createRoot), Hu.hydrateRoot;
/**
    ...
    const n = oe.forwardRef(
      (
        ...
        oe.createElement(
          ...
          [
            ...t.map(([m, p]) => oe.createElement(m, p)),
            ...(Array.isArray(s) ? s : [s]),
          ]
        )
    );
 ...
 */ const Vd = Ze("X", [
  ...
  Bd = ({ text: e, delay: t = 100, className: n = "" }) => {
    const [r, l] = oe.useState(""),
      [i, o] = oe.useState(0);
    return (
      oe.useEffect(() => {
        if (i < e.length) {
      ...
      v.jsxs("span", {
        ...
        children: [
          r,
          v.jsx("span", { className: "animate-pulse", children: "|" }),
        ],
      })
    );
  },
  Hd = () => {
    ...
    oe.useEffect(() => {
      const u = () => {
        ...
        for (const m of h.reverse()) {
          const p = document.getElementById(m);
          if (p && window.scrollY >= p.offsetTop - 100) {
            i(m);
            break;
          }
        }
    ...
    return v.jsxs("nav", {
      className:
        "fixed top-0 w-full bg-gray-900/95 backdrop-blur-sm z-50 shadow-lg",
      children: [
        v.jsx("div", {
          className: "relative",
          children: v.jsx("div", {
        ...
        v.jsxs("div", {
          ...
          children: [
            v.jsx("div", {
              className:
                "text-white text-xl font-bold hover:text-purple-400 transition-colors cursor-pointer",
              onClick: () => o("hero"),
              children: "Devish Kumar",
            }),
            v.jsx("button", {
              className: "md:hidden text-gray-300 focus:outline-none",
              onClick: () => t(!e),
              children: e ? v.jsx(Vd, { size: 28 }) : v.jsx($d, { size: 28 }),
            }),
            v.jsx("div", {
              ...
              children: [
                ...
                v.jsx(
                  "button",
                  {
                    onClick: () => o(u),
                    className: `${
                      l === u ? "text-purple-400" : "text-gray-300"
        ...
        e &&
          v.jsx("div", {
            className:
              "md:hidden bg-gray-800/95 backdrop-blur-sm flex flex-col space-y-4 px-6 py-4 animate-fadeIn",
            children: [
              "projects",
              "skills",
              "experience",
  ...
  wn = ({
    ...
    v.jsxs("div", {
      className:
        "bg-gray-800 rounded-lg overflow-hidden shadow-xl border border-gray-700 transform hover:scale-[1.02] transition-transform duration-300",
      children: [
        v.jsxs("div", {
          className: "relative",
          children: [
        ...
        v.jsxs("div", {
          ...
          children: [
            ...
            v.jsx("p", { className: "text-gray-300 mb-4", children: t }),
            v.jsx("div", {
              ...
              children: r.map((o, u) =>
                v.jsx(
                  ...
                  {
                    className:
                      "px-3 py-1 bg-purple-900/50 text-purple-100 rounded-full text-sm border border-purple-700",
                    children: o,
                  },
                  u
                )
            ...
            v.jsxs("a", {
              href: l,
              className:
                "inline-flex items-center text-purple-400 hover:text-purple-300 transition-colors group",
              children: [
                "View Project ",
                v.jsx(Od, {
                  className:
                    "ml-2 transform group-hover:translate-x-1 transition-transform",
                  size: 16,
                }),
              ],
            }),
  ...
  return v.jsxs("div", {
    ...
    children: [
      ...
      v.jsx("header", {
        id: "hero",
        className:
          "bg-gradient-to-r from-purple-900 to-blue-900 text-white pt-24",
        children: v.jsxs("div", {
          className:
            "container mx-auto px-6 py-24 flex flex-col md:flex-row items-center md:items-start h-full",
          children: [
            v.jsxs("div", {
              className: "text-left max-w-3xl md:w-2/3",
              children: [
                v.jsx("h1", {
                  className: "text-5xl font-bold mb-6 animate-fadeInUp",
                  children: v.jsx(Bd, {
                    text: "Hey there, I'm Devish Kumar",
                    delay: 80,
                  }),
                }),
                v.jsxs("p", {
                  className:
                    "text-xl mb-4 animate-fadeInUp animation-delay-200",
                  children: [
                    "Freshman at DTU Delhi",
                    v.jsx("br", {}),
                ...
                v.jsx("p", {
                  className:
                    "text-lg text-gray-200 mb-8 leading-relaxed animate-fadeInUp animation-delay-400",
                  children:
                    "Passionate about building innovative solutions that make a difference. I specialize in full-stack development, systems programming, and data analysis. Currently exploring the intersections of technology and social impact through projects in emergency response systems and infrastructure management.",
                }),
                v.jsxs("div", {
                  className:
                    "flex space-x-6 animate-fadeInUp animation-delay-600",
                  children: [
                    v.jsx("a", {
                      target: "_blank",
                      href: "https://github.com/DevishKumar",
                      className:
                        "hover:text-purple-300 transition-colors transform hover:scale-110",
                      children: v.jsx(Ud, { size: 24 }),
                    }),
                    v.jsx("a", {
                      target: "_blank",
                      href: "https://www.linkedin.com/in/devish-kumar-32557531a/",
                      className:
                        "hover:text-purple-300 transition-colors transform hover:scale-110",
                      children: v.jsx(Ad, { size: 24 }),
                    }),
                    v.jsx("a", {
                      target: "_blank",
                      href: "mailto:devishkumar_cse_25a02034@dtu.ac.in",
                      className:
                        "hover:text-purple-300 transition-colors transform hover:scale-110",
                      children: v.jsx(Qu, { size: 24 }),
                    }),
                  ],
                }),
              ],
            ...
            v.jsx("div", {
              className:
                "mt-8 md:mt-0 md:w-1/3 flex justify-center animate-fadeInRight",
              children: v.jsxs("div", {
                className: "relative group",
                children: [
                  v.jsx("div", {
                    className:
                      "absolute -inset-1 bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200",
                  }),
                  v.jsx("img", {
                    src: "pfp.jpg",
                    className:
                      "relative w-32 h-32 md:w-48 md:h-48 rounded-2xl object-cover",
                    alt: "Profile",
                  }),
                ],
              }),
            ...
            v.jsxs("div", {
              ...
              children: [
                v.jsx(wn, {
                  title: "Rephaus",
                  description:
                    "Rephaus is a smart celebrity events and profile management system that streamlines inventory tracking, financial monitoring, and data organization using data based automation.",
                  image: "./figma_logo.jpg",
                  technologies: ["UI/UX", "Designing", "HTML/CSS"],
                  link: "https://www.figma.com/design/OFAyIaxR1MXXq3gINjHO1q/Rephaus-2?node-id=0-1&p=f&t=inIGTIFqLf0Gtddn-0",
                }),
              ],
            }),
          ],
            ...
            v.jsx("div", {
              ...
              children: [
                ...
                v.jsx(
                  ...
                  {
                    className:
                      "px-6 py-3 bg-gray-900 text-purple-300 rounded-full text-lg border border-purple-500 hover:bg-purple-900 transition-all duration-300 transform hover:scale-110",
                    style: {
                      animationDelay: `${l * 100}ms`,
              ...
              children: [
                {
                  ...
                  company: "Zentivate, U.K",
                  period: "Sep 2025 - Present",
                  location: "Off Campus",
                  guide: "Mr. Sehran Noor",
                  description:
                    "Working on Figma, an industry-level project under a startup founder, creating a Django web app with a MySQL database to generate and manage QR codes for lab equipment. Gaining hands-on experience in web development and database integration.",
                ...
                v.jsxs(
                  ...
                  {
                    className:
                      "p-6 bg-gray-800 rounded-lg border border-gray-700 transform hover:scale-[1.02] transition-all duration-300",
                    children: [
                      v.jsxs("div", {
            ...
            v.jsx("div", {
              ...
              children: [
                ...
                v.jsxs(
                  ...
                  {
                    className:
                      "p-6 bg-gray-900 rounded-lg border border-gray-700 transform hover:scale-[1.02] transition-all duration-300",
                    children: [
                      v.jsxs("div", {
                        className: "flex items-center space-x-4 mb-4",
                        children: [
                          v.jsx(Md, { className: "w-8 h-8 text-purple-400" }),
                          v.jsx("h3", {
                            className: "text-xl font-semibold text-white",
                            children: r.title,
                          }),
        ...
        children: v.jsxs("div", {
          ...
          children: [
            ...
            v.jsx("p", {
              ...
              children:
                "I'm currently looking for internship opportunities and would love to connect with you. Feel free to reach out if you'd like to discuss potential collaborations or just chat about technology!",
            }),
            v.jsxs("a", {
              href: "mailto:devishkumar_cse_25a02034@dtu.ac.in",
              className:
                "inline-flex items-center px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-all duration-300 transform hover:scale-105 group",
              children: [
                v.jsx(Qu, {
      ...
      v.jsx("button", {
        ...
        className: `fixed bottom-8 right-8 p-3 rounded-full bg-purple-600 text-white shadow-lg transition-all duration-300 ${
          e ? "opacity-100 translate-y-0" : "opacity-0 translate-y-16"
        }`,
        children: v.jsx("svg", {
          className: "w-6 h-6",
          fill: "none",
      ...
      v.jsx("footer", {
        className: "bg-gray-950 text-gray-400 py-8",
        children: v.jsx("div", {
          className: "container mx-auto px-6 text-center",
          children: v.jsx("p", {
            children: "© 2025 Devish Kumar. All rights reserved.",
          }),
        }),
      }),
    ],
...
rc(document.getElementById("root")).render(
  v.jsx(oe.StrictMode, { children: v.jsx(Qd, {}) })
);
